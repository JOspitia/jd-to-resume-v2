...
│   ├── src/                  
│   │   ├── App.tsx           # Router toggling layout views
│   │   ├── LandingPage.tsx   # Premium Neo-Brutalism landing page
│   │   ├── ToolApp.tsx       # Core Application Form logic
│   │   └── index.css         # Strict Neo-Brutalist CSS directives
│   ├── components.json       # Shadcn UI configs
│   ├── tailwind.config.js    # Specialized Shadow & Border settings
